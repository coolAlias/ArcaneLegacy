...
public class GuiMagicBag extends GuiContainer
{
	...
	private static final ResourceLocation iconLocation = new ResourceLocation(ModInfo.ID, "textures/gui/magicbag.png");
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2)
	{
		...
		fontRenderer.drawString(I18n.getString("container.inventory"), 26, ySize - 96 + 4, 4210752);
	}
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
	{
		...
		int i1;
		drawPlayerModel(k + 51, l + 75, 30, (float)(k + 51) - xSize_lo, (float)(l + 75 - 50) - ySize_lo, mc.thePlayer);
	}

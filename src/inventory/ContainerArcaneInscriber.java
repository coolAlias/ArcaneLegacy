...
public class ContainerArcaneInscriber extends Container
{
	...
	public ContainerArcaneInscriber(InventoryPlayer inventoryPlayer, TileEntityArcaneInscriber par2TileEntityArcaneInscriber)
	{
		...
		for (i = 0; i < RUNE_SLOTS; ++i) {
			this.addSlotToContainer(new SlotArcaneInscriberDischarge(par2TileEntityArcaneInscriber, DISCHARGE[i], 44 + (18*i), 64));
		}
    ...
    {
    	this.inscriber.setInventorySlotContents(RECIPE, this.inscriber.getCurrentRecipe());
    	this.inscriber.onInventoryChanged();
    }
    */

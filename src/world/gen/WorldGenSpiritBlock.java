package coolalias.arcanelegacy.world.gen;
...
public class WorldGenSpiritBlock extends WorldGenerator
{
	public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        {
            par1World.setBlock(par3, par4, par5, ALBlocks.blockSpirit.blockID, 0, 2);
            ...
            for (int l = 0; l < 1500; ++l)
            {
                ...
                if (par1World.getBlockId(i1, j1, k1) == 0)
                {
                    ...
                    if (l1 == 1)
                    {
                        par1World.setBlock(i1, j1, k1, ALBlocks.blockSpirit.blockID, 0, 2);
                    }
                }
            }
